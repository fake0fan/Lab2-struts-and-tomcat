...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
	...
	<ul class="nav menu">
		...
		<li class="active"><a href="authorquery.jsp"><em class="fa fa-calendar">&nbsp;</em> 作者查询</a></li>
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active">作者查询</li>
		</ol>
	</div><!--/.row-->

	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">作者查询</h1>
		</div>
	</div><!--/.row-->
			...
			<form class="form-horizontal" action="name">
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input id="name" name="name" type="text" placeholder="Author name" class="form-control">
						</div>
					</div>
