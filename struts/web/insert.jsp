...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li class="active"><a href="insert.jsp"><em class="fa fa-calendar">&nbsp;</em> 添加新书籍</a></li>
        ...
        <div class="panel-body">
            <form class="form-horizontal" action="insert">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input id="ISBN" name="ISBN"  onkeyup="value=value.replace(/[^\d]/g,'')" type="text" placeholder="ISBN" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input id="price" name="Price" onkeyup="value=value.replace(/[^\d.]/g,'')" type="text" placeholder="Price" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input id="publisher" name="Publisher" type="text" placeholder="Publisher" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input data-date-format="yyyy-mm-dd" data-provide="datepicker" id="publishdate" name="PublishDate" type="date" placeholder="Publish Date" class="form-control">
                        </div>
                    </div>
